var authorization;
const findMessageTitle = require('../../config').findMessageTitle;
    ...
    getMusicInfo: function (message) {
      ...
      wx.request({
          ...
          success:function(res){ 
            console.log(findMessageTitle+"?authorization="+authorization);
            console.log("shuju:",res.data.messageGroup);
           
            if(res.data.messageGroup == undefined){
              ...
              console.log(res)
              var contentlistTem = that.data.messageGroup
              if (res.data.state == 200) {
                ...
                var contentlist = res.data.messageGroup;
